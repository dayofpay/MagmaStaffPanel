...
namespace MagmaStaffPanel
{
    public partial class Points : Form
    {
        ...
        {
            listBox1.Items.Add(DefaultUI.logged_username);
            connection = new MySqlConnection(DefaultUI.conString);
            connection.Open();
            using (MySqlCommand cmd = new MySqlCommand
       ("SELECT points FROM currentpoints WHERE staff = " + "'" + DefaultUI.logged_username + "'" + ";", connection))
            {
...
("SELECT date_removed FROM removedpoints WHERE staff = " + "'" + DefaultUI.logged_username + "'" + ";", connection))
                    {
...
("SELECT remove_reason FROM removedpoints WHERE staff = " + "'" + DefaultUI.logged_username + "'" + ";", connection))
                        {
...
("SELECT removed_by FROM removedpoints WHERE staff = " + "'" + DefaultUI.logged_username + "'" + ";", connection))
                        {
