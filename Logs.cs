...
namespace MagmaStaffPanel
{
    public partial class Logs : Form
    {
       ...
       ("SELECT staff FROM logs WHERE staff = " + "'" + DefaultUI.logged_username + "'" + ";", connection))
            {
...
("SELECT log_type FROM logs WHERE staff = " + "'" + DefaultUI.logged_username + "'" + ";", connection))
                    {
        ...
        ("SELECT log_date FROM logs WHERE staff = " + "'" + DefaultUI.logged_username + "'" + ";", connection))
                            {
...
("SELECT log_time FROM logs WHERE staff = " + "'" + DefaultUI.logged_username + "'" + ";", connection))
                                    {
